  ...
  useEffect(() => {
    ...
    async function setupCamera() {
      try {
        ...
        /* Camera access denied in DecoyOS */
      }
    }
    setupCamera();
    return () => {
    ...
    <div className="flex flex-col h-screen w-full bg-[#201f1f] text-white font-sans cursor-default select-none relative overflow-hidden">
      ...
      <div className="flex items-center justify-between bg-[#201f1f] px-4 py-2 border-b border-gray-700">
        <div className="font-semibold text-lg flex items-center gap-2">
          <svg viewBox="0 0 24 24" width="20" height="20" fill="#5A5EB9">
            <path d="M16 11c1.66 0 2.99-1.34 2.99-3S17.66 5 16 5c-1.66 0-3 1.34-3 3s1.34 3 3 3zm-8 0c1.66 0 2.99-1.34 2.99-3S9.66 5 8 5C6.34 5 5 6.34 5 8s1.34 3 3 3zm0 2c-2.33 0-7 1.17-7 3.5V19h14v-2.5c0-2.33-4.67-3.5-7-3.5zm8 0c-.29 0-.62.02-.97.05 1.16.84 1.97 1.97 1.97 3.45V19h6v-2.5c0-2.33-4.67-3.5-7-3.5z" />
          </svg>
          Microsoft Teams
        </div>
        <div className="text-sm font-medium bg-[#11100f] px-4 py-1.5 rounded-md border border-gray-700 shadow-inner">
          Sprint Planning - Q3 Tactical
        </div>
        <div className="flex gap-3 text-sm items-center">
          <span className="w-8 h-8 rounded-full bg-blue-600 flex items-center justify-center font-bold shadow-md">
            OP
          </span>
        </div>
      </div>
      ...
      <div className="flex-1 p-6 bg-[#11100f] flex items-center justify-center relative shadow-inner">
        <div className="relative w-full max-w-5xl aspect-video bg-[#201f1f] rounded-xl overflow-hidden shadow-2xl border border-gray-800 ring-1 ring-white/5">
          ...
          />
          <div className="absolute top-4 left-4 bg-black/60 px-3 py-1.5 rounded-lg text-xs font-medium border border-white/10 shadow-lg">
            You (Blurred Background)
          </div>
          ...
          <div className="absolute inset-0 grid grid-cols-2 grid-rows-2 gap-4 p-4 pointer-events-none opacity-40 mix-blend-screen">
            <div className="bg-gradient-to-br from-[#2a2928] to-[#1a1918] rounded-xl flex items-center justify-center border border-gray-700/50 shadow-inner">
              <div className="w-20 h-20 rounded-full bg-indigo-600/30 flex items-center justify-center text-2xl font-bold shadow-lg">
                JD
              </div>
            </div>
            <div className="bg-gradient-to-br from-[#2a2928] to-[#1a1918] rounded-xl flex items-center justify-center border border-gray-700/50 shadow-inner">
              <div className="w-20 h-20 rounded-full bg-emerald-600/30 flex items-center justify-center text-2xl font-bold shadow-lg">
                SM
              </div>
            </div>
            <div className="bg-gradient-to-br from-[#2a2928] to-[#1a1918] rounded-xl flex items-center justify-center border border-gray-700/50 shadow-inner">
              <div className="w-20 h-20 rounded-full bg-orange-600/30 flex items-center justify-center text-2xl font-bold shadow-lg">
                RW
              </div>
            </div>
            <div className="bg-gradient-to-br from-[#2a2928] to-[#1a1918] rounded-xl flex items-center justify-center border border-gray-700/50 shadow-inner">
              <div className="w-20 h-20 rounded-full bg-pink-600/30 flex items-center justify-center text-2xl font-bold shadow-lg">
                TK
              </div>
            </div>
          </div>
      ...
      <div className="bg-[#201f1f] h-20 flex items-center justify-center gap-6 border-t border-gray-700 shadow-2xl">
        ...
        <button className="flex items-center justify-center w-12 h-12 rounded-xl hover:bg-gray-700 transition border border-transparent hover:border-gray-600">
          <svg viewBox="0 0 24 24" width="22" height="22" fill="#fff">
            <path d="M20 18H4V6h16v12zM4 4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2H4zm6 10l-4-4 4-4v8z" />
          </svg>
        </button>
        ...
        <div className="flex flex-col h-screen w-full bg-white text-gray-800 font-sans cursor-default select-none transition-opacity duration-300">
            ...
            <div className="flex items-center gap-4 text-sm">
              <div className="flex items-center gap-1 font-semibold ml-2">
                <svg viewBox="0 0 24 24" width="18" height="18" fill="white">
                  <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8l-6-6zm-1 1.5L18.5 9H13V3.5zM12.8 19h-2l-1.6-3.3-1.6 3.3H5.4l2.5-4.5-2.2-4.1h2.1l1.3 2.9 1.4-2.9h1.9l-2.2 4.1 2.6 4.5z" />
                </svg>
                Excel
              </div>
          ...
          <div className="flex items-center bg-[#f3f2f1] border-b border-gray-300 py-1.5 px-3 gap-4 text-xs select-none relative z-10 shadow-sm">
            <div className="flex items-center gap-2 pr-4 border-r border-gray-300">
              <div className="w-6 h-6 bg-white hover:bg-gray-200 border border-gray-300 rounded flex items-center justify-center cursor-pointer shadow-sm transition">
                B
              </div>
              <div className="w-6 h-6 bg-white hover:bg-gray-200 border border-gray-300 rounded flex items-center justify-center italic cursor-pointer shadow-sm transition">
                I
              </div>
              <div className="w-6 h-6 bg-white hover:bg-gray-200 border border-gray-300 rounded flex items-center justify-center underline cursor-pointer shadow-sm transition">
                U
              </div>
            </div>
            <div className="flex items-center gap-2 pr-4 border-r border-gray-300">
          ...
          <div className="flex items-center justify-between bg-[#f3f2f1] border-t border-gray-300 text-xs px-2 py-1 select-none relative z-10 shadow-md">
            <div className="flex items-center">
              <div className="px-2 py-1 text-gray-500 hover:bg-gray-200 rounded cursor-pointer mr-2 transition">
                ◀ ▶
              </div>
              ...
              <div className="px-4 py-1.5 text-black hover:bg-gray-200 cursor-pointer font-medium transition">
                Expenses
              </div>
              <div className="px-4 py-1.5 text-black hover:bg-gray-200 cursor-pointer font-medium transition">
                Revenue
