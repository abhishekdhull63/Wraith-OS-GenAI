      ...
      <div className="max-w-4xl w-full border-4 border-red-600 bg-red-950/20 shadow-[0_0_50px_rgba(220,38,38,0.3)] p-8">
        <div className="flex flex-col items-center mb-8 border-b-4 border-red-600 pb-8 text-center">
          ...
          <h2 className="text-xl font-bold text-red-400 mb-4">
            Shamir's Secret Sharing // 3-of-5 Cryptographic Threshold
          </h2>
          <p className="text-sm text-red-300 max-w-2xl px-8">
            WARNING: Executing this protocol will permanently detach the Master AES-GCM derivation key from local memory
            and IndexedDB. The vault's encryption salt will be mathematically fractured into 5 independent physical QR
            vectors.
          </p>
          ...
          <div className="flex flex-col items-center gap-6 py-12">
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-red-400">
                There is no digital recovery matrix. If you lose 3 shards, the vault is cryptographically unrecoverable
                forever.
              </p>
            </div>
          ...
          <div className="animate-fade-in">
            <div className="text-center mb-8">
              ...
              <p className="text-sm text-red-400 font-bold">
                The below 5 physical artifacts are now the sole existing keys to the AES cipher lock.
              </p>
              <p className="text-xs text-red-500 mt-1">
                Download and distribute these securely. Print them. De-digitize them.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-6 mb-12">
              {sharesUrls.map((share) => (
                <div
                  key={share.id}
                  className="border-2 border-red-800 bg-black p-4 flex flex-col items-center text-center"
                >
                  <span className="text-xs font-bold text-red-500 mb-2 uppercase tracking-widest">
                    Shard {share.id}/5
                  </span>
                  <img
                    src={share.url}
                    alt={`Horcrux ${share.id}`}
                    className="w-full aspect-square border-2 border-white rendering-pixelated mb-4 bg-white"
                  />
                  <button
